...
bool zamienSekundyNaDniIGodziny(int sekundy, int *dni, int *godziny, int *minuty) {
    ...
    *minuty = pozostaleSekundy / 60;
    ...
    return true;
        ...
        cerr << "Podana wartość sekund jest nieprawidlowa" << endl;
        return false;
...
int main() {
    ...
    if (zamienSekundyNaDniIGodziny(sekundy, &dni, &godziny, &minuty))
    {
